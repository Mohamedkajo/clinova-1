...
export const platformRoutes = [
  ...
  route("GET", exact("/api/platform/backups"), { module: "platform" }),
  route("POST", exact("/api/platform/backups"), { module: "platform" }),
  ...
  route("DELETE", matches(/^\/api\/platform\/tenants\/\d+$/), { module: "platform" }),
